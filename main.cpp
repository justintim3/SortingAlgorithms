...
int main() {
	...
	const int sizeStart = 1, sizeEnd = 3;	//sizeStart and sizeEnd determine the range of array sizes to calculate runtimes for
	int loopNumber = 1000;	//Determines the number of times to loop to average the runtimes for sorts
